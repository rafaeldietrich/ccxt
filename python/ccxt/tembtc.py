...
class tembtc (Exchange):

    def describe(self):
        return self.deep_extend(super(tembtc, self).describe(), {
            'id': 'tembtc',
            'name': 'tembtc',
            'countries': ['BR'],
            'rateLimit': 1000,
            ...
            'urls': {
                ...
                'api': {
                    'public': 'https://broker.tembtc.com.br/api/v3',
                    'private': 'https://broker.tembtc.com.br/tradeapi/v1',
                },
                'www': 'https://www.tembtc.com.br',
                'doc': [
                    'https://www.tembtc.com.br/documentacao-tradeapi',
                    'https://www.tembtc.com.br/documentacao-api',
                ],
                'fees': 'https://www.tembtc.com.br/comissoes',
            },
            'api': {
                'public': {
                    'get': [
